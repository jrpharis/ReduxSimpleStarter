...
class BookList extends Component {
  renderList() {
    console.log("RenderList: " + this.props.books.length + " books");
  ...
  render() {
    return <ul className="list-group col-sm-5">{this.renderList()}</ul>;
  }
}
...
// Aything returned from this functino will end up
...
// needs to know abou this new dispatch method, selectBook.
